                ...
                <form className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="relative z-0 w-full group">
                            <input type="text" name="name" id="name" className="block py-3 px-0 w-full text-base text-white bg-transparent border-0 border-b border-white/50 appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " required />
                            ...
                            <div className="absolute bottom-0 left-0 w-full h-[2px] bg-white origin-left scale-x-0 peer-focus:scale-x-100 transition-transform duration-300 ease-linear" />
                        </div>
                        <div className="relative z-0 w-full group">
                            <input type="email" name="email" id="email" className="block py-3 px-0 w-full text-base text-white bg-transparent border-0 border-b border-white/50 appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " required />
                    ...
                    <div className="relative z-0 w-full group">
                        <textarea name="message" id="message" rows={4} className="block py-3 px-0 w-full text-base text-white bg-transparent border-0 border-b border-white/50 appearance-none focus:outline-none focus:ring-0 peer resize-none" placeholder=" " required></textarea>
